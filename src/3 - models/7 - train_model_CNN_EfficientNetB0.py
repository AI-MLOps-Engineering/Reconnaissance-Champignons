...
Modèle CNN avec Transfer Learning EfficientNetB0
...
# Préprocess EfficientNetB0 (à la place du Rescaling)
...
model_efficientb0 = Model(inputs, outputs)
...
save = tf.keras.callbacks.ModelCheckpoint(
    rep_model + "CNN_TL_model_efficientb0.keras",
    monitor="val_loss",
    mode="min",
    save_best_only=True
)
...
history_model = model_efficientb0.fit(
    train_ds,
...
np.save(rep_model+"CNN_TL_model_efficientnetb0_history.npy", history_model.history)
